...
admin.setup = function(app, prefix, username, password, db, _sections) {
    sections[prefix] = [];
...
admin.setupProjects = function(app, prefix, db) {
    ...
    app.post(prefix + '/projects/apn', function(req, res) {
        ...
        var bundleId = req.body.bundle_id;
        var tokenKey = req.body.token.key;
        var tokenKeyId = req.body.token.key_id;
        var tokenTeamId = req.body.token.team_id;
        var production = (typeof req.body.production !== 'undefined' ?
